...
namespace OOPPractice9
{
    class Program
    {
        ...
        {
            int length = InputNumOfElements("Введите длину массива: ","Ошибка: введите неотрицательное число");
            return new TriangleArray(length,ref rndGen);
        }

        static TriangleArray InitArrayMan()
        {
            int length = InputNumOfElements("Введите длину массива: ");
